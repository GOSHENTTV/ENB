...
//NETTOYAGE
float SharpDay < string UIName = "Netteté de jour"; float UIMin = 0.0; float UIMax = 10.0; > = { 1.8 };
float SharpNight < string UIName = "Netteté de nuit"; float UIMin = 0.0; float UIMax = 10.0; > = { 1.6 };

//BRUIT
int separator0 < string UIName = " "; int UIMin = 0; int UIMax = 0; > = { 0 };
float ldd < string UIName = "Bruit Jour:: lumDark"; float UIMin = -1.0; float UIMax = 1.0; float UIStep = 0.0001; > = { 0.0021 };
float lbd < string UIName = "Bruit Jour:: lumBright"; float UIMin = -1.0; float UIMax = 1.0; float UIStep = 0.0001; > = { 0.0021 };
float ldn < string UIName = "Bruit Nuit:: lumDark"; float UIMin = -1.0; float UIMax = 1.0; float UIStep = 0.0001; > = { 0.0011 };
float lbn < string UIName = "Bruit Nuit:: lumBright"; float UIMin = -1.0; float UIMax = 1.0; float UIStep = 0.0001; > = { 0.0011 };

//ANTI-ALIASING
int separator1 < string UIName = "  "; int UIMin = 0; int UIMax = 0; > = { 0 };
float DXAA < string UIName = "DXAA"; float UIMin = 0.0; float UIMax = 12.0; > = { 4.0 };
float SubPix < string UIName = "FXAA:: SubPixel"; float UIMin = 0.0; float UIMax = 1.0; > = { 0.7 };
float EdgeThresh < string UIName = "FXAA:: Seuil de bord"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.001; > = { 0.166 };
float EdgeThreshMin < string UIName = "FXAA:: Seuil de bord min"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.001; > = { 0.0833 };

//GOUTTES DE PLUIE
int separator2 < string UIName = "   "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool rd < string UIName = "Gouttes de pluie à l'écran"; > = { true };
float ra < string UIName = "Gouttes de pluie:: Quantité"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 0.32 };
float ri < string UIName = "Gouttes de pluie:: Intensité"; float UIMin = 0.0; float UIMax = 10.0; > = { 1.0 };
float rs < string UIName = "Gouttes de pluie:: Échelle"; float UIMin = 0.1; float UIMax = 5.0; > = { 0.52 };
float re < string UIName = "Gouttes de pluie:: Vitesse"; float UIMin = 0.0; float UIMax = 6.0; > = { 0.43 };
float rblur < string UIName = "Gouttes de pluie:: Flou"; float UIMin = 0.0; float UIMax = 1.5; > = { 0.0 };
float rvig < string UIName = "Gouttes de pluie:: Vignette"; float UIMin = 0.0; float UIMax = 1.0; > = { 0.0 };
bool rf < string UIName = "Gouttes de pluie:: Forcer l'activation"; > = { false };

//NEIGE GELEE
//bool rp <string UIName="RainDrops:: Vehicle Physics";> = {true};
int separator3 < string UIName = "    "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool s_s < string UIName = "Neige gelée à l'écran"; > = { true };

//ARC-EN-CIEL
int separator4 < string UIName = "     "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool rb_enable < string UIName = "Arc-en-ciel"; > = { true };
bool rb_double < string UIName = "Arc-en-ciel#1:: Double"; > = { false };
float rb_int < string UIName = "Arc-en-ciel#1:: Intensité"; float UIMin = 0.0; float UIMax = 0.4; float UIStep = 0.001; > = { 0.05 };
float rb_scale < string UIName = "Arc-en-ciel#1:: Taille"; float UIMin = 0.0; float UIMax = 800.0; float UIStep = 1.0; > = { 130.0 };
float3 posrb < string UIName = "Arc-en-ciel#1:: Coordonnées"; /*string UIType = "vector";*/ float UIStep = 5.0; > = { 600.0, -3000.0, 0.0 };
float3 rb_dir < string UIName = "Arc-en-ciel#1:: Direction"; string UIType = "vector"; > = { 0.5, 0.7, 0.5 };
bool rb_force < string UIName = "Arc-en-ciel#1:: Forcer l'activation"; > = { false };
int miniseparator0 < string UIName = "- - - - - - - -"; int UIMin = 0; int UIMax = 0; > = { 0 };
bool rb2_double < string UIName = "Arc-en-ciel#2:: Double"; > = { false };
float rb2_int < string UIName = "Arc-en-ciel#2:: Intensité"; float UIMin = 0.0; float UIMax = 0.4; float UIStep = 0.001; > = { 0.05 };
float rb2_scale < string UIName = "Arc-en-ciel#2:: Taille"; float UIMin = 0.0; float UIMax = 800.0; float UIStep = 1.0; > = { 90.0 };
float3 posrb2 < string UIName = "Arc-en-ciel#2:: Coordonnées"; /*string UIType = "vector";*/ float UIStep = 5.0; > = { 3900.0, 5000.0, 8.0 };
float3 rb2_dir < string UIName = "Arc-en-ciel#2:: Direction"; string UIType = "vector"; > = { 0.5, 0.7, 0.5 };
bool rb2_force < string UIName = "Arc-en-ciel#2:: Forcer l'activation"; > = { false };
int miniseparator1 < string UIName = "- - - - - - - - "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool rb3_double < string UIName = "Arc-en-ciel#3:: Double"; > = { false };
float rb3_int < string UIName = "Arc-en-ciel#3:: Intensité"; float UIMin = 0.0; float UIMax = 0.4; float UIStep = 0.001; > = { 0.11 };
float rb3_scale < string UIName = "Arc-en-ciel#3:: Taille"; float UIMin = 0.0; float UIMax = 800.0; float UIStep = 1.0; > = { 40.0 };
float3 posrb3 < string UIName = "Arc-en-ciel#3:: Coordonnées"; /*string UIType = "vector";*/ float UIStep = 5.0; > = { -1400.0, 4400.0, 1.0 };
float3 rb3_dir < string UIName = "Arc-en-ciel#3:: Direction"; string UIType = "vector"; > = { 0.5, 0.7, 0.5 };
bool rb3_force < string UIName = "Arc-en-ciel#3:: Forcer l'activation"; > = { false };

//FLOU RADIAL
int separator5 < string UIName = "      "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool blu < string UIName = "Flou radial"; > = { false };
float bi < string UIName = "Flou radial:: Intensité"; float UIMin = -0.3; float UIMax = 0.3; float UIStep = 0.001; > = { 0.1 };
int bs < string UIName = "Flou radial:: Échantillons"; int UIMin = 32; int UIMax = 128; > = { 64 };
float2 bmsxy < string UIName = "Flou radial:: Masque"; float UIMin = 0.0; float UIMax = 10.0; > = { 1.0, 1.0 };
float bms < string UIName = "Flou radial:: Taille du masque"; float UIMin = 0.0; float UIMax = 10.0; > = { 0.25 };
bool mf1 < string UIName = "Flou radial:: Mise au point manuelle : Clic gauche"; > = { false };
bool mf2 < string UIName = "Flou radial:: Mise au point manuelle : Clic droit"; > = { false };

//ABERRATION CHROMATIQUE
int separator6 < string UIName = "       "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool bvca < string UIName = "Aberration chromatique verticale"; > = { false };
float vca < string UIName = "Aberration chromatique verticale:: Intensité"; float UIMin = -0.0025; float UIMax = 0.0025; float UIStep = 0.0001; > = { 0.0005 };
bool bca < string UIName = "Aberration chromatique radiale"; > = { false };
float rca < string UIName = "Aberration chromatique radiale:: Intensité"; float UIMin = 0.001; float UIMax = 0.05; float UIStep = 0.001; > = { 0.006 };
int cat < string UIName = "Aberration chromatique radiale:: Type"; int UIMin = 1; int UIMax = 6; > = { 1 };

//DISTORSION DE LA LENTILLE
int separator7 < string UIName = "        "; int UIMin = 0; int UIMax = 0; > = { 0 };
float ldistort < string UIName = "Distorsion de la lentille (GoPro)"; float UIMin = 0.0; float UIMax = 1.0; > = { 0.0 };

//GRILLE DE COMPOSITION
int separator8 < string UIName = "         "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool grid1 < string UIName = "Grille de composition:: Nombre d'or"; > = { false };
bool grid2 < string UIName = "Grille de composition:: Symétrie"; > = { false };
bool grid3 < string UIName = "Grille de composition:: Triangle d'or"; > = { false };
bool grid4 < string UIName = "Grille de composition:: Triangle d'or inversé"; > = { false };
float ddepth < string UIName = "Profondeur Z"; float UIStep = 0.0001; > = { 0.0 };

//ARRIERE-PLAN
int separator9 < string UIName = "          "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool useback < string UIName = "Arrière-plan"; > = { false };
float fadein < string UIName = "Arrière-plan:: Fondu en entrée"; float UIMin = 0.0; float UIStep = 0.5; > = { 38.0 };
float fadeout < string UIName = "Arrière-plan:: Fondu en sortie"; float UIMin = 0.0; float UIStep = 0.5; > = { 40.0 };
float scale < string UIName = "Arrière-plan:: Échelle"; float UIMin = 0.0; > = { 2.0 };
float2 pos < string UIName = "Arrière-plan:: Position"; > = { 0.0, -1.25 };
bool unwrap < string UIName = "Arrière-plan:: Déballer la texture"; > = { false };

//FILTRE PHOTO
int separator10 < string UIName = "           "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool cc < string UIName = "Filtre photo:: Courbe de chrominance"; > = { false };
float ccm < string UIName = "Filtre photo::   Courbe de chrominance"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.001; > = { 0.5 };
float ccb < string UIName = "Filtre photo::   Luminosité de la courbe de chrominance"; float UIMin = 0.0; float UIMax = 10.0; float UIStep = 0.001; > = { 0.81 };
bool bw < string UIName = "Filtre photo:: Noir et blanc"; > = { false };
float bwg < string UIName = "Filtre photo::   Gamma noir et blanc"; float UIMin = 0.0; float UIMax = 10.0; float UIStep = 0.001; > = { 0.57 };
float bwb < string UIName = "Filtre photo::   Luminosité noir et blanc"; float UIMin = 0.0; float UIMax = 10.0; float UIStep = 0.001; > = { 0.46 };

//LUT
int separator11 < string UIName = "            "; int UIMin = 0; int UIMax = 0; > = { 0 };
bool lut < string UIName = "Utiliser la texture LUT"; > = { false };
float gli < string UIName = "LUT:: Intensité GLOBALE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float ini < string UIName = "LUT:: Intensité NUIT INTÉRIEURE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float isi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL INTÉRIEUR"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float idi < string UIName = "LUT:: Intensité JOUR INTÉRIEUR"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float exni < string UIName = "LUT:: Intensité NUIT TRÈS ENSOLEILLÉE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float exsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL TRÈS ENSOLEILLÉ"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float exdi < string UIName = "LUT:: Intensité JOUR TRÈS ENSOLEILLÉ"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float clni < string UIName = "LUT:: Intensité NUIT CLAIRE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float clsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL CLAIR"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float cldi < string UIName = "LUT:: Intensité JOUR CLAIR"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float cgni < string UIName = "LUT:: Intensité NUIT ÉCLAIRCIE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float cgsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL ÉCLAIRCI"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float cgdi < string UIName = "LUT:: Intensité JOUR ÉCLAIRCI"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float coni < string UIName = "LUT:: Intensité NUIT NUAGEUSE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float cosi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL NUAGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float codi < string UIName = "LUT:: Intensité JOUR NUAGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float ovni < string UIName = "LUT:: Intensité NUIT COUVERTE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float ovsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL COUVERT"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float ovdi < string UIName = "LUT:: Intensité JOUR COUVERT"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float smni < string UIName = "LUT:: Intensité NUIT SMOG"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float smsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL SMOG"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float smdi < string UIName = "LUT:: Intensité JOUR SMOG"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float foni < string UIName = "LUT:: Intensité NUIT BRUMEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float fosi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL BRUMEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float fodi < string UIName = "LUT:: Intensité JOUR BRUMEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float rani < string UIName = "LUT:: Intensité NUIT PLUVIEUSE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float rasi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL PLUVIEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float radi < string UIName = "LUT:: Intensité JOUR PLUVIEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float thni < string UIName = "LUT:: Intensité NUIT ORAGEUSE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float thsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL ORAGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float thdi < string UIName = "LUT:: Intensité JOUR ORAGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float blni < string UIName = "LUT:: Intensité NUIT BLIZZARD"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float blsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL BLIZZARD"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float bldi < string UIName = "LUT:: Intensité JOUR BLIZZARD"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float neni < string UIName = "LUT:: Intensité NUIT NEUTRE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float nesi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL NEUTRE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float nedi < string UIName = "LUT:: Intensité JOUR NEUTRE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float snni < string UIName = "LUT:: Intensité NUIT NEIGEUSE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float snsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL NEIGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float sndi < string UIName = "LUT:: Intensité JOUR NEIGEUX"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float slni < string UIName = "LUT:: Intensité NUIT NEIGEUSE LÉGÈRE"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float slsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL NEIGEUX LÉGER"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float sldi < string UIName = "LUT:: Intensité JOUR NEIGEUX LÉGER"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float xmni < string UIName = "LUT:: Intensité NUIT NOËL"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float xmsi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL NOËL"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float xmdi < string UIName = "LUT:: Intensité JOUR NOËL"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float hani < string UIName = "LUT:: Intensité NUIT HALLOWEEN"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float hasi < string UIName = "LUT:: Intensité COUCHER DE SOLEIL HALLOWEEN"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
float hadi < string UIName = "LUT:: Intensité JOUR HALLOWEEN"; float UIMin = 0.0; float UIMax = 1.0; float UIStep = 0.005; > = { 1.0 };
...
VS_OUTPUT_POSTRB VS_Rb(VS_INPUT_POST IN)
{
	...
	OUT.pos.w = 1.0;
	OUT.txcoord0.xy = IN.txcoord.xy;
	float4 rpos = mul(float4(posrb, 1.0), WorldViewProj);
	rpos.xyz /= rpos.w;
...
VS_OUTPUT_POSTRB VS_Rb2(VS_INPUT_POST IN)
{
	...
	OUT.pos.w = 1.0;
	OUT.txcoord0.xy = IN.txcoord.xy;
	float4 rpos = mul(float4(posrb2, 1.0), WorldViewProj);
	rpos.xyz /= rpos.w;
	rpos.xyz = rpos.xyz * float3(0.5, -0.5, -0.5) + float3(0.5, 0.5, 0.5);
	rpos.xy = IN.txcoord.xy - rpos.xy;
	rpos.xy = rpos.xy * DofProj.xy * rpos.w;
...
VS_OUTPUT_POSTRB VS_Rb3(VS_INPUT_POST IN)
{
	...
	OUT.pos.w = 1.0;
	OUT.txcoord0.xy = IN.txcoord.xy;
	float4 rpos = mul(float4(posrb3, 1.0), WorldViewProj);
	rpos.xyz /= rpos.w;
	rpos.xyz = rpos.xyz * float3(0.5, -0.5, -0.5) + float3(0.5, 0.5, 0.5);
	rpos.xy = IN.txcoord.xy - rpos.xy;
	rpos.xy = rpos.xy * DofProj.xy * rpos.w;
...
VS_OUTPUT_POSTRD VS_W2(VS_INPUT_POST IN)
{
	VS_OUTPUT_POSTRD OUT;
	OUT.pos.xyz = IN.pos.xyz;
	OUT.pos.w = 1.0;
	OUT.txcoord0.xy = IN.txcoord.xy;
	OUT.txcoord1.xy = rcpFrame * rblur;
	return OUT;
}
...
VS_OUTPUT_POST3 VS_Background(VS_INPUT_POST IN)
{
	...
	OUT.pos.w = 1.0;
	OUT.txcoord0.xy = IN.txcoord.xy;
	float2 uv = IN.txcoord.xy * float2(2.0, -2.0) + float2(-1.0, 1.0);
	uv *= DofProj.xy;
	OUT.txcoord1.xyz = mul(float3(uv, -1.0), (float3x3)ViewInverse);
	return OUT;
}
...
{
	float4 y,w,z,x,s,r,T;if(f.txcoord1.z)y.xy=float2(.000833,.00011)*Test1.y,y.z=f.txcoord0.x<.5,y.yz=y.z?y.xy:-y.xy,w.xy=f.txcoord0.z*float2(30.,1.85)+y.yz,y.w=f.txcoord0.w*30+y.x,w.x=-Test1.z*.049+w.x,y.w=Test1.w*.012+y.w,z.x=floor(w.x),z.y=floor(y.w),x.x=frac(w.x),x.y=frac(y.w),w.xz=x.xy-.5,y.w=dot(z.xy,float2(107.45,3543.65)),z.xyz=float3(.13787,.11369,.1031)*y.w,z.xyz=frac(z.xyz),x.xyz=19.19+z.yxz,y.w=dot(z.zyx,x.xyz),z.xyz=z.xyz+y.w,x.xyz=z.zzy+z.yxx,z.xyz=x.xyz*z.xyz,z.xyz=frac(z.xyz),z.xy=z.xy-.5,w.xz=-z.xy*.7+w.xz,y.w=dot(w.xz,w.xz),y.w=sqrt(y.w),y.w=-.3+y.w,y.w=-3.33333*y.w,y.w=max(0,y.w),w.x=y.w*-2+3,y.w=y.w*y.w,y.w=w.x*y.w,w.x=10*z.z,w.x=frac(w.x),y.w=w.x*y.w,w.x=f.txcoord1.w+z.z,w.x=frac(w.x),w.z=40*w.x,w.z=min(1,w.z),w.w=w.z*-2+3,w.z=w.z*w.z,w.z=w.w*w.z,w.x=w.x-1.,w.x=-1.02564*w.x,w.x=min(1,w.x),w.w=w.x*-2+3,w.x=w.x*w.x,w.x=w.w*w.x,w.x=w.z*w.x,y.w=w.x*y.w,w.x=.75*f.txcoord1.w,w.z=f.txcoord0.w*1.85+w.x,w.z=Test1.y*.00011+w.z,z.x=-Test1.z*.006+w.y,w.y=Test1.w*.00171+w.z,w.z=12*z.x,w.z=floor(w.z),w.z=12345.6*w.z,w.z=sin(w.z),w.z=7658.76*w.z,w.z=frac(w.z),z.y=w.y+w.z,w.yz=float2(12,2)*z.xy,z.xy=floor(w.yz),w.w=dot(z.xy,float2(35.2,2376.1)),z.xyz=float3(.1031,.11369,.13787)*w.w,z.xyz=frac(z.xyz),x.xyz=19.19+z.yzx,w.w=dot(z.xyz,x.xyz),z.xyz=z.xyz+w.w,z.yw=z.xy+z.yz,z.xy=z.yw*z.zx,z.xy=frac(z.xy),x.xy=frac(w.yz),w.y=-1+x.y,w.zw=z.xy-.5,z.xz=float2(37,18.5)*f.txcoord0.w,z.x=sin(z.x),z.x=f.txcoord0.w*37+z.x,z.x=sin(z.x),z.w=.5-abs(w.z),z.x=z.x*z.w,w.z=z.x*w.w+w.z,s.x=.7*w.z,w.z=f.txcoord1.w+z.y,w.z=frac(w.z),w.w=1.17647*w.z,w.w=min(1,w.w),z.x=w.w*-2+3,w.w=w.w*w.w,w.w=z.x*w.w,w.z=-1+w.z,w.z=-6.66667*w.z,w.z=min(1,w.z),z.x=w.z*-2+3,w.z=w.z*w.z,w.z=z.x*w.z,w.z=w.w*w.z-.5,s.yz=w.z*.9+float2(.5,-.5),x.zw=x.x-.5,w.zw=-s.xy+x.zy,z.xy=float2(1,6)*w.zw,w.z=dot(z.xy,z.xy),w.z=sqrt(w.z),w.zw=float2(-.4,.02)+w.zw,w.z=-2.5*w.z,w.z=max(0,w.z),z.x=w.z*-2+3,z.y=rcp(s.z),w.y=saturate(z.y*w.y),z.y=w.y*-2+3,w.y=w.y*w.y,w.y=z.y*w.y,w.y=sqrt(w.y),w.w=saturate(25*w.w),z.y=w.w*-2+3,w.w=w.w*w.w,w.w=z.y*w.w,z.y=frac(z.z),z.y=x.y+z.y,s.w=-.5+z.y,z.yz=-s.xw+x.wy,z.y=dot(z.yz,z.yz),z.y=sqrt(z.y),z.y=-.3+z.y,z.y=-3.33333*z.y,z.y=max(0,z.y),z.z=z.y*-2+3,z.y=z.y*z.y,z.y=z.z*z.y,w.y=z.y*w.y,w.yz=w.yz*w.wz,w.y=z.x*w.z+w.y,w.y=f.txcoord1.y*w.y,y.w=y.w*f.txcoord1.x+w.y,y.w=-.3+y.w,y.w=saturate(.588235*y.w),w.y=y.w*-2+3,y.w=y.w*y.w,y.w=w.y*y.w,z.xyzw=float4(.001,0,0,.001)+f.txcoord0.zwzw,w.yz=z.xx*float2(30,1.85)+y.yz,w.w=z.y*30+y.x,w.y=-Test1.z*.049+w.y,w.w=Test1.w*.012+w.w,x.xy=floor(w.yw),s.xy=frac(w.yw),w.yw=s.xy-.5,z.x=dot(x.xy,float2(107.45,3543.65)),x.xyz=float3(.13787,.11369,.1031)*z.x,x.xyz=frac(x.xyz),s.xyz=19.19+x.yxz,z.x=dot(x.zyx,s.xyz),x.xyz=x.xyz+z.x,s.xyz=x.zzy+x.yxx,x.xyz=s.xyz*x.xyz,x.xyz=frac(x.xyz),x.xy=x.xy-.5,w.yw=-x.xy*.7+w.yw,w.y=dot(w.yw,w.yw),w.y=sqrt(w.y),w.y=-.3+w.y,w.y=-3.33333*w.y,w.y=max(0,w.y),w.w=w.y*-2+3,w.y=w.y*w.y,w.y=w.w*w.y,w.w=10*x.z,w.w=frac(w.w),w.y=w.y*w.w,w.w=f.txcoord1.w+x.z,w.w=frac(w.w),z.x=40*w.w,z.x=min(1,z.x),x.x=z.x*-2+3,z.x=z.x*z.x,z.x=x.x*z.x,w.w=-1+w.w,w.w=-1.02564*w.w,w.w=min(1,w.w),x.x=w.w*-2+3,w.w=w.w*w.w,w.w=x.x*w.w,w.w=z.x*w.w,w.y=w.y*w.w,w.w=z.y*1.85+w.x,w.w=Test1.y*.00011+w.w,x.x=-Test1.z*.006+w.z,w.z=Test1.w*.00171+w.w,w.w=12*x.x,w.w=floor(w.w),w.w=12345.6*w.w,w.w=sin(w.w),w.w=7658.76*w.w,w.w=frac(w.w),x.y=w.z+w.w,w.zw=float2(12,2)*x.xy,x.xy=floor(w.zw),z.x=dot(x.xy,float2(35.2,2376.1)),x.xyz=float3(.1031,.11369,.13787)*z.x,x.xyz=frac(x.xyz),s.xyz=19.19+x.yzx,z.x=dot(x.xyz,s.xyz),x.xyz=x.xyz+z.x,x.yw=x.xy+x.yz,x.xy=x.yw*x.zx,x.xy=frac(x.xy),s.xy=frac(w.zw),w.z=-1+s.y,x.xz=x.xy-.5,r.xy=float2(37,18.5)*z.yy,w.w=sin(r.x),w.w=z.y*37+w.w,w.w=sin(w.w),z.x=.5-abs(x.x),w.w=z.x*w.w,w.w=w.w*x.z+x.x,T.x=.7*w.w,w.w=f.txcoord1.w+x.y,w.w=frac(w.w),z.x=1.17647*w.w,z.x=min(1,z.x),z.y=z.x*-2+3,z.x=z.x*z.x,z.x=z.y*z.x,w.w=-1+w.w,w.w=-6.66667*w.w,w.w=min(1,w.w),z.y=w.w*-2+3,w.w=w.w*w.w,w.w=z.y*w.w,w.w=z.x*w.w-.5,T.yz=w.w*.9+float2(.5,-.5),s.zw=s.x-.5,z.xy=-T.xy+s.zy,x.xy=float2(1,6)*z.xy,w.w=dot(x.xy,x.xy),w.w=sqrt(w.w),w.w=-.4+w.w,w.w=-2.5*w.w,w.w=max(0,w.w),z.x=w.w*-2+3,w.w=w.w*w.w,x.x=rcp(T.z),w.z=saturate(x.x*w.z),x.x=w.z*-2+3,w.z=w.z*w.z,w.z=x.x*w.z,w.z=sqrt(w.z),z.y=.02+z.y,z.y=saturate(25*z.y),x.x=z.y*-2+3,z.y=z.y*z.y,z.y=x.x*z.y,x.x=frac(r.y),x.x=s.y+x.x,T.w=-.5+x.x,x.xy=-T.xw+s.wy,x.x=dot(x.xy,x.xy),x.x=sqrt(x.x),x.x=-.3+x.x,x.x=-3.33333*x.x,x.x=max(0,x.x),x.y=x.x*-2+3,x.x=x.x*x.x,x.x=x.y*x.x,w.z=x.x*w.z,w.z=w.z*z.y,w.z=z.x*w.w+w.z,w.z=f.txcoord1.y*w.z,w.y=w.y*f.txcoord1.x+w.z,w.y=-.3+w.y,w.y=saturate(.588235*w.y),w.z=w.y*-2+3,y.y=z.z*30+y.y,y.x=z.w*30+y.x,y.y=-Test1.z*.049+y.y,y.x=Test1.w*.012+y.x,z.xy=floor(y.yx),x.xy=frac(y.yx),y.xy=x.xy-.5,w.w=dot(z.xy,float2(107.45,3543.65)),x.xyz=float3(.13787,.11369,.1031)*w.w,x.xyz=frac(x.xyz),s.xyz=19.19+x.yxz,w.w=dot(x.zyx,s.xyz),x.xyz=x.xyz+w.w,s.xyz=x.zzy+x.yxx,x.xyz=s.xyz*x.xyz,x.xyz=frac(x.xyz),z.xy=x.xy-.5,y.xy=-z.xy*.7+y.xy,y.x=dot(y.xy,y.xy),y.x=sqrt(y.x),y.x=-.3+y.x,y.x=-3.33333*y.x,y.x=max(0,y.x),y.y=y.x*-2+3,y.x=y.x*y.x,y.x=y.y*y.x,y.y=10*x.z,y.y=frac(y.y),y.x=y.x*y.y,y.y=f.txcoord1.w+x.z,y.y=frac(y.y),w.w=40*y.y,w.w=min(1,w.w),z.x=w.w*-2+3,w.w=w.w*w.w,w.w=z.x*w.w,y.y=-1+y.y,y.y=-1.02564*y.y,y.y=min(1,y.y),z.x=y.y*-2+3,y.y=y.y*y.y,y.y=z.x*y.y,y.y=w.w*y.y,y.x=y.x*y.y,z.xy=float2(37,18.5)*z.w,y.y=z.w*1.85+w.x,y.z=z.z*1.85+y.z,y.y=Test1.y*.00011+y.y,x.x=-Test1.z*.006+y.z,y.y=Test1.w*.00171+y.y,y.z=12*x.x,y.z=floor(y.z),y.z=12345.6*y.z,y.z=sin(y.z),y.z=7658.76*y.z,y.z=frac(y.z),x.y=y.y+y.z,y.yz=float2(12,2)*x.xy,w.xw=floor(y.yz),w.x=dot(w.xw,float2(35.2,2376.1)),x.xyz=float3(.1031,.11369,.13787)*w.x,x.xyz=frac(x.xyz),s.xyz=19.19+x.yzx,w.x=dot(x.xyz,s.xyz),x.xyz=x.xyz+w.x,w.xw=x.xy+x.yz,w.xw=w.xw*x.zx,w.xw=frac(w.xw),x.xy=frac(y.yz),y.y=-1+x.y,s.xy=w.xw-.5,y.z=sin(z.x),y.z=z.w*37+y.z,y.z=sin(y.z),w.x=.5-abs(s.x),y.z=w.x*y.z,y.z=y.z*s.y+s.x,s.x=.7*y.z,y.z=f.txcoord1.w+w.w,y.z=frac(y.z),w.x=1.17647*y.z,w.x=min(1,w.x),w.w=w.x*-2+3,w.x=w.x*w.x,w.x=w.w*w.x,y.z=-1+y.z,y.z=-6.66667*y.z,y.z=min(1,y.z),w.w=y.z*-2+3,y.z=y.z*y.z,y.z=w.w*y.z,y.z=w.x*y.z-.5,s.yz=y.z*.9+float2(.5,-.5),x.zw=x.x-.5,w.xw=-s.xy+x.zy,z.xz=float2(1,6)*w.xw,y.z=dot(z.xz,z.xz),y.z=sqrt(y.z),y.z=-.4+y.z,y.z=-2.5*y.z,y.z=max(0,y.z),w.x=y.z*-2+3,y.z=y.z*y.z,z.x=rcp(s.z),y.y=saturate(z.x*y.y),z.x=y.y*-2+3,y.y=y.y*y.y,y.y=z.x*y.y,y.y=sqrt(y.y),w.w=.02+w.w,w.w=saturate(25*w.w),z.x=w.w*-2+3,w.yw=w.yw*w.yw,w.w=z.x*w.w,z.x=frac(z.y),z.x=x.y+z.x,s.w=-.5+z.x,z.xy=-s.xw+x.wy,z.x=dot(z.xy,z.xy),z.x=sqrt(z.x),z.x=-.3+z.x,z.x=-3.33333*z.x,z.x=max(0,z.x),z.y=z.x*-2+3,z.x=z.x*z.x,z.x=z.y*z.x,y.y=z.x*y.y,y.y=y.y*w.w,y.y=w.x*y.z+y.y,y.y=f.txcoord1.y*y.y,y.x=y.x*f.txcoord1.x+y.y,y.x=-.3+y.x,y.x=saturate(.588235*y.x),y.y=y.x*-2+3,y.x=y.x*y.x,w.x=w.z*w.y-y.w,w.y=y.y*y.x-y.w,y.x=1.-saturate(ExteriorInterior),y.xy=w.xy*y.xx,y.z=1.-Test2.y,y.xy=y.xy*y.zz,w.xyz=f.txcoord0.xxy-.5,y.z=100.*w.x,y.z=y.z*y.z,y.z=min(1,y.z),y.zw=y.xy*y.zz,w.xw=f.txcoord0.xy*float2(4.,1.)+float2(-2.,-.5),w.x=dot(w.xw,w.xw),w.x=min(1.,w.x),w.w=.055*Test2.x,w.w=min(1.,w.w),y.xy=y.xy*w.xx-y.zw,y.xy=w.w*y.xy+y.zw,y.zw=w.yz*float2(3,3)+float2(.03,-.24),y.z=dot(y.zw,y.zw),y.z=y.z*y.z+1.,y.z=saturate(-rvig+y.z),y.xy=y.xy*y.z;else y.xy=0.;y.w=bool(length(y.xy));y.xyz=TextureColor.SampleLevel(Sampler1,f.txcoord0.xy+ri*y.xy,0).xyz;return y;
};

float4 PS_W2(VS_OUTPUT_POSTRD IN) : SV_Target
{
	float4 res = TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy, 0.0);
	float3 blur = res.xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + float2(IN.txcoord1.x, 0.0), 0).xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + IN.txcoord1.xy * float2(0.5, 0.86602540378), 0).xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + IN.txcoord1.xy * float2(-0.5, 0.86602540378), 0).xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + float2(-IN.txcoord1.x, 0.0), 0).xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + IN.txcoord1.xy * float2(-0.5, -0.86602540378), 0).xyz;
	blur += TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + IN.txcoord1.xy * float2(0.5, -0.86602540378), 0).xyz;
	blur /= 7.0;
	res.xyz = lerp(res.xyz, blur, res.w);
	return res;
}
...
float4 PS_Frozen(VS_OUTPUT_POSTRD IN) : SV_Target
{
	...
	tex.xy -= 0.5;
	float vig = pow(1.0 - smoothstep(0.975, 0.05, length(IN.txcoord0.xy - 0.5) * IN.txcoord1.y), 7.0) * IN.txcoord1.y * s_s * (1.0 - saturate(ExteriorInterior));
	float noise = frac(sin(dot(IN.txcoord0.xy, float2(12.9898, 78.233))) * 43758.5453);
	noise *= 0.025 * vig + pow(tex.z, 4.0) * vig * IN.txcoord1.x;
	float3 res = TextureColor.SampleLevel(Sampler1, IN.txcoord0.xy + tex.xy * vig, 0).xyz;
	res = lerp(res, 1.0, saturate(noise * 5.0));
	return float4(res,1);
}
...
float4 PS_Background(VS_OUTPUT_POST3 IN) : SV_Target
{
	...
	if (useback) {
		float3 uv = normalize(IN.txcoord1.xyz);
		uv.x = atan2(uv.x, uv.y);
		uv.y = acos(uv.z);
		uv.xy += pos;
		uv.xy *= scale;
		float2 texSize; backtex.GetDimensions(texSize.x, texSize.y);
		uv.y *= texSize.x / texSize.y;
		float4 tex = (unwrap) ? backtex.SampleLevel(Sampler3, uv.xy, 0) : backtex.SampleLevel(Sampler2, uv.xy, 0);
		res = lerp(res, lerp(res, tex.xyz, tex.w), smoothstep(fadein, fadeout, depth));
	}
	return float4(res, 1);
}

technique11 Aaron < string UIName = "AaronX"; >
{
	pass p0
	{
...
technique11 Aaron2 < string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron6 < string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron10 < string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron14 < string RenderTarget = "RenderTargetRGBA64F"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
...
technique11 Aaron25
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_W2()));
		SetPixelShader(CompileShader(ps_5_0, PS_W2()));
	}
}
...
technique11 AaronL < string UIName = "AaronX low preset"; >
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Rb()));
